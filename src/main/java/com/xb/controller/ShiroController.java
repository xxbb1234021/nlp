...
import com.xb.common.config.shiro.ShiroConfiguration;
...
public class ShiroController {
	...
	public String getUserList(Map<String, Object> model) {
		//model.put("userList", userInfoService.findAll());
		return "user";
	}
	...
	public ModelAndView userInfoAdd() {
		ModelAndView mav = new ModelAndView("/views/userInfoAdd.html");
		return mav;
	}
